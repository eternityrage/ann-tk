...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        # Prepare message
        message = description if description else "✨ Ana de Armas Daily!\n\n#anadearmas #hollywood #celebrity #fashion"
        ...
        video = upload.video(
            ...
            name=title or 'Ana de Armas Daily Video',
...
def main():
    ...
    description = sys.argv[2] if len(sys.argv) > 2 else "Daily Ana de Armas Moment! ✨"
    title = sys.argv[3] if len(sys.argv) > 3 else "Ana de Armas Daily"
